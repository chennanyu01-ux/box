...
function factors(annual,dayun,profile){
 ...
 if('丑未'.includes(annual[1]))add('G-天乙','甲日天乙贵人取丑、未：流年'+annual[1]+'命中；仅加机会项',[0,0,0,4]);
 return rows;
}
